module branchPredictor #(
  ...
  localparam [1:0] sTaken = 2'b10, wTaken = 2'b00,  //default taken
  wNtaken = 2'b01, sNtaken = 2'b11;
  ...
  always_ff @(posedge clk) begin
    if (!rst) begin
      if (exHit | exTaken) btb_mem[exIndex] <= exEntryUpdated;
    end
  end
